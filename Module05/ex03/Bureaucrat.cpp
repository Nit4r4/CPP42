...
/*   Updated: 2023/03/23 14:44:00 by vferraro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::ostream	&operator <<(std::ostream &out, const Bureaucrat &obj)
{
	if (obj.getGrade() <= 100 && obj.getGrade() > 0) {
		out << "\e[32mWelcome " << obj.getName() << " you are " << obj.getGrade() << " grade !\e[0m" << " ";
	}
	else if (obj.getGrade() > 100  && obj.getGrade() <= 150) {
		out << "\033[35mWelcome " << obj.getName() << " you are " << obj.getGrade() << " grade...\e[0m" << " ";
	}
	return (out);
}
...
// 	try {
// 			form.execute((*this));
// 			if (form.getExecGrade() > 5)
// 				throw AForm::GradeTooLowException();
// 			else if (form.getExecGrade() < 1)
